...
class BusinessSettingsController extends Controller
{
    ...
    public function business_index(Request $request, $tab = 'business')
    {
        ...
        if ($tab == 'business') {
            ...
            $order_typs =Helpers::get_business_settings('order_types');
            $order_types_status =Helpers::get_business_settings('order_types_status');

            return view('admin-views.business-settings.order-index', compact('order_types_status','reasons', 'type','order_typs'));
        } else if ($tab == 'store') {
    ...
    public function update_order(Request $request)
    {
        ...
        DB::table('business_settings')->updateOrInsert(['key' => 'cart_n_home_status'], [
            'value' => $request['cart_n_home_status']
        ]);        
        
        DB::table('business_settings')->updateOrInsert(['key' => 'offers_home_status'], [
            'value' => $request['offers_home_status']
        ]);        
        
        DB::table('business_settings')->updateOrInsert(['key' => 'news_home_status'], [
            'value' => $request['news_home_status']
        ]);       
        
        DB::table('business_settings')->updateOrInsert(['key' => 'order_types_status'], [
            'value' => $request['order_types_status']
        ]);

        DB::table('business_settings')->updateOrInsert(['key' => 'banner_home_status'], [
            'value' => $request['banner_home_status']
        ]);
        DB::table('business_settings')->updateOrInsert(['key' => 'pop_home_order_status'], [
            'value' => $request['pop_home_order_status']
        ]);

        DB::table('business_settings')->updateOrInsert(['key' => 'order_retern_time'], [
            'value' => $request['order_retern_time']
        ]);
...
// dd( $request['commission_business_model']);
    ...
    {
        $order_policy = DataSetting::withoutGlobalScope('translate')->where('type', 'admin_landing_page')->where('key', 'order_policy')->first();
        $order_policy_status = DataSetting::where('type', 'admin_landing_page')->where('key', 'order_policy_status')->first();
        return view('admin-views.business-settings.order_policy', compact('order_policy', 'order_policy_status'));
    }

    public function order_update(Request $request)
    {
        $this->update_data($request, 'order_policy');
        Toastr::success(translate('messages.order_policy_updated'));
        return back();
    }
    public function order_policy_status($status)
    {
        $this->policy_status_update('order_policy_status', $status);
