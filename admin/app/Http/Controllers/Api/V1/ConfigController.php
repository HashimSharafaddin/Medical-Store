...
,'pop_home_order_status','order_types_status','news_home_status','offers_home_status','cart_n_home_status','order_retern_time','banner_home_status'
        ...
        //نوع الطلب
        $order_types = [];
        $order_type = Helpers::get_business_settings('order_types');
        // if (isset($apples)) {
            foreach (Helpers::get_business_settings('order_types') as $order_type) {
                $config1 = [
...
'news_home_status' => isset($settings['news_home_status']) ?(boolean)$settings['news_home_status'] : false,
'offers_home_status' => isset($settings['offers_home_status']) ? (boolean)$settings['offers_home_status'] : false,
'cart_n_home_status' => isset($settings['cart_n_home_status']) ? (boolean)$settings['cart_n_home_status'] : false,
'pop_home_order_status' => isset($settings['pop_home_order_status']) ? (boolean)$settings['pop_home_order_status'] : false,
'order_types_status' => isset($settings['order_types_status']) ? (boolean)$settings['order_types_status'] : false,
'order_retern_time' => (int)(isset($settings['order_retern_time']) ? $settings['order_retern_time'] : 0),
'banner_home_status' => isset($settings['banner_home_status']) ? (boolean)$settings['banner_home_status'] : false,

            'unit' => $unit ,
            // 'offers_home_status' => (boolean)$settings['offers_home_status'],
            // 'cart_n_home_status' => (boolean)$settings['cart_n_home_status'],
            // 'pop_home_order_status' => (boolean)$settings['pop_home_order_status'],
...
//            'landing_page_settings_full_url'=> $data['web_app_landing_page_settings_storage']??'public',
            ...
            'order_policy' => (int)(self::get_settings_status('order_policy_status')),
            ...
            'fastـdelivery' => (float)(isset($settings['fastـdelivery']) ? $settings['fastـdelivery'] : 0),
