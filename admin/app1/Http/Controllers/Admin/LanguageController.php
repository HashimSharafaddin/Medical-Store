...
class LanguageController extends Controller
{
    ...
    {       $order_typs = BusinessSetting::where('key', 'order_typs')->exists();
        if(!$order_typs){
            Helpers::insert_business_settings_key('order_typs','[{"id":1,"name":"عادي","amount":0,"status":1}]');
        }
        return view('admin-views.business-settings.cancelation-reason');
    }
