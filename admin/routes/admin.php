...
//        });
        ...
        Route::group(['prefix' => 'store', 'as' => 'store.'], function () {
            ...
            Route::get('get-store-name/{id}', 'VendorController@get_store_name')->name('get_store_name');
        ...
        Route::group(['prefix' => 'order', 'as' => 'order.', 'middleware' => ['module:order']], function () {
            ...
            Route::get('get-order-data', 'OrderController@getOrderData')->name('get-order-data');
            Route::get('update-price', 'OrderController@updatePrice')->name('update-price');
            ...
            Route::get('update-quantity', 'OrderController@updateQuantity')->name('update-quantity');
        ...
        Route::group(['prefix' => 'refund', 'as' => 'refund.', 'middleware' => ['module:order']], function () {
            ...
            Route::get('refund_attr', 'OrderController@list_refund')->name('refund_attr');
            Route::get('refund-details/{id}', 'OrderController@refund_details')->name('refund-details');
            Route::get('refund-update-price', 'OrderController@refundUpdatePrice')->name('refund-update-price');
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.', 'middleware' => ['module:settings', 'actch']], function () {
            ...
            Route::get('order-typs/status/{id}/{status}', 'OrderCancelReasonController@status')->name('order-typs.status');
            Route::get('order-typs', 'OrderCancelReasonController@index')->name('order-typs.index');
            Route::post('order-typs/store', 'OrderCancelReasonController@store2')->name('order-typs.store');
            Route::put('order-typs/update', 'OrderCancelReasonController@update')->name('order-typs.update');
            Route::delete('order-typs/destroy/{id}', 'OrderCancelReasonController@destroy')->name('order-typs.destroy');
            Route::get('order-typs/status2/{type}/{status}', 'OrderCancelReasonController@status2')->name('order-typs.status2');
            Route::post('order-typs/update2', 'OrderCancelReasonController@updateOrderType')->name('order-typs.update2');
            ...
            Route::get('pages/business-page/order', 'BusinessSettingsController@order_policy')->name('order');
            Route::post('pages/business-page/order', 'BusinessSettingsController@order_update');
            Route::get('pages/order-policy/{status}', 'BusinessSettingsController@order_policy_status')->name('order-policy-status');
        ...
        Route::group(['prefix' => 'transactions', 'as' => 'transactions.'], function () {
            ...
            Route::group(['prefix' => 'account-transaction', 'as' => 'account-transaction.', 'middleware' => ['module:collect_cash']], function () {
                ...
                Route::get('method-list/{id}', 'AccountTransactionController@method_list')->name('method-list');
