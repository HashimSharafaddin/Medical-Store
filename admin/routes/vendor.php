...
Route::group(['namespace' => 'Vendor', 'as' => 'vendor.'], function () {
    ...
    Route::group(['middleware' => ['vendor']], function () {
        ...
        Route::group([ 'prefix' => 'advertisement', 'as' => 'advertisement.' ,'middleware' => ['module:advertisement','subscription:coupon']], function () {
            ...
            Route::get('/is-comments/{iscomments}', 'AdvertisementController@isComments')->name('is-comments');
        ...
        Route::group(['prefix' => 'order', 'as' => 'order.' , 'middleware' => ['module:order']], function () {
            ...
            Route::get('item-success/{id}', 'OrderController@itemSuccess')->name('item-success');
            Route::get('get-order-data', 'OrderController@orderData')->name('get-order-data');
            ...
            Route::get('refund', 'OrderController@list_refund')->name('refund');
