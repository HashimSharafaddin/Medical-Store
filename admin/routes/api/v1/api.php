...
Route::group(['namespace' => 'Api\V1', 'middleware'=>'localization'], function () {
    ...
    Route::get('/order-policy', 'HomeController@order_policy');
    ...
    Route::group(['prefix' => 'auth', 'namespace' => 'Auth'], function () {
        ...
        Route::post('upload-image', 'CustomerAuthController@uplodeImag');
    ...
    Route::group(['prefix' => 'delivery-man'], function () {
        ...
        Route::group(['middleware'=>['dm.api']], function () {
            ...
            Route::post('update-ready-status', 'DeliverymanController@readyStatus');
            ...
            Route::put('accept-order-item', 'DeliverymanController@accept_order_item');
    ...
    Route::group(['middleware'=>['module-check']], function(){
        ...
        Route::group(['prefix' => 'customer', 'middleware' => 'apiGuestCheck'], function () {
            Route::group(['prefix' => 'order'], function () {
                ...
                Route::put('accepted', 'OrderController@accepted_order');
            ...
            Route::group(['prefix'=>'cart'], function() {
                ...
                Route::post('add-comment', 'CartController@add_comment');
                Route::post('select-item', 'CartController@selectItem');
                Route::post('select-all', 'CartController@selectAll');
                Route::post('send-to-cart', 'CartController@sendToCart');
                Route::post('add-like', 'CartController@add_like');
                Route::post('add-note-cart', 'CartController@add_note');
                Route::post('add-products-cart', 'CartController@add_products');
        ...
        Route::post('advertisement/add-comment', 'AdvertisementController@add_comment');
