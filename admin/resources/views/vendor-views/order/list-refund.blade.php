            ...
            <div class="card-body p-0">
                ...
                <div class="table-responsive datatable-custom">
                    <table id="datatable" class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table"
                        ...
                        {{-- @php($total_amount = App\Models\OrderDetail::where(['store_id' => \App\CentralLogics\Helpers::get_store_id(),'order_id'=> $order->id])->sum('price')) --}}
                            ...
                            <tr class="status-{{$order['order_status']}} class-all">
                                ...
                                <td>
                                    <div>
                                        {{date('d M Y',strtotime($order->refund['created_at']))}}
                                    </div>
                                    <div class="d-block text-uppercase">
                                        {{date(config('timeformat'),strtotime($order->refund['created_at']))}}
                                    </div>
                                </td>
                                {{-- <td>
                                    @if($order->is_guest)
                                ...
                                <td>
                                    <div class="text-right mw--85px">
                                        <div>
                                            {{\App\CentralLogics\Helpers::format_currency($order->refund['refund_amount'])}}
                                        </div>
                                ...
                                <td>{{translate($order->refund['order_status'])}}</td>
                                ...
                                <td>
                                    <div class="btn--container justify-content-center">
                                        <a class="btn btn-sm btn--warning btn-outline-warning action-btn" href="{{route('vendor.order.refund-details',['id'=>$order['id']])}}"><i class="tio-visible-outlined"></i></a>
