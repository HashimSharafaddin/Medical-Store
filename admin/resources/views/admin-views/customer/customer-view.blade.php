                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4 class="card-title d-flex flex-wrap align-items-center gap-2">
                            ...
                            <span class="badge badge-soft-info">{{ translate('user_type') }}: {{ translate($customer['user_type'])}}</span>
                        </h4>
                    </div>
                    <!-- End Header -->
                            ...
                            <div class="media gap-3 flex-wrap">
                                ...
                                <div class="media-body">
                                    <div class="key-value-list d-flex flex-column gap-2 text-dark" style="--min-width: 60px">
                                        ...
                                        {{-- <div class="key-val-list-item d-flex gap-3">
                                            <div>{{ translate('street') }}</div>:
                                            <div class="font-semibold">{{ $customer['street']??"" }}</div>
                                        </div> --}}
                                    ...
                                    <ul class="list-unstyled m-0">
                                        <li class="pb-1 d-flex align-items-center">
                                            ...
                                            <span> صوره البطاقه </span>

                                                <img class="avatar avatar-xxl avatar-4by3 mr-4 onerror-image" width="100" height="70" data-onerror-image="{{asset('public/assets/admin/img/160x160/img1.jpg')}}" src="{{\App\CentralLogics\Helpers::get_full_url('profile', $customer->id_image,'s3') }}"
                                                alt="Image Description">
                                        </li>
                                        <li class="pb-1 d-flex align-items-center">
                                            <i class="tio-shopping-basket-outlined mr-2"></i>
                                            <span> صوره تصريح الصيدليه </span>
                                            
                                                <img class="avatar avatar-xxl avatar-4by3 mr-4 onerror-image" width="100" height="70" data-onerror-image="{{asset('public/assets/admin/img/160x160/img1.jpg')}}" src="{{\App\CentralLogics\Helpers::get_full_url('profile', $customer->imageT,'s3') }}"
                                                alt="Image Description">
                                        </li>
                                    </ul>
                                </div>
