                    ...
                    <table id="datatable"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="border-0">{{ translate('نوع الحساب') }}</th>
                                <th class="border-0">{{ translate('اسم الصيدليه') }}</th>
                        ...
                        <tbody id="set-rows">
                            @foreach ($customers as $key => $customer)
                                ...
                                <tr class="">
                                    ...
                                    <td>
                                        <label class="badge">
                                            {{ translate($customer->user_type??"") }}
                                        </label>
                                    </td> 
                                    {{-- @if($customer->pharmcy_name =="") --}}
                                    <td>
                                        <label class="badge">
                                            {{ $customer->pharmcy_name }}
                                        </label>
                                    </td>
                                    <td>
                                        <label class="badge">
