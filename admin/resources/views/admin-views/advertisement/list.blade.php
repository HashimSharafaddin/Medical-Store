                ...
                <table class="font-size-sm table table-borderless table-thead-bordered table-nowrap table-align-middle card-table min-h-225px">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <label class="toggle-switch toggle-switch-sm ml-xl-4" for="stocksCheckbox{{ $add->id }}">
                                    <input type="checkbox" data-url="{{ route('admin.advertisement.is-comments',$add->id) }}" data-message="{{ $add->iscomments? translate('messages.you_want_to_block_this_customer'): translate('messages.you_want_to_unblock_this_customer') }}"
                                        class="toggle-switch-input status_change_alert" id="stocksCheckbox{{ $add->id }}"
                                        {{ $add->iscomments ? 'checked' : '' }}>
