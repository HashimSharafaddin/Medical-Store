            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">
                        ...
                        <span>
                            {{ _('طلب مرتجع') }} <span
                                class="badge badge-soft-dark rounded-circle ml-1">{{ $order->details->where('refund_request',1)->count() }}</span>
                        </span>
                    </h1>
                </div>
                       ...
                       $product_price= 0;
                        ...
                        <div class="table-responsive">
                            <table
                                ...
                                <tbody>
                                    @foreach ($order->details->where('refund_request',1) as $key => $detail)
                            ...
                            <div class="mb-4">
                                <div class="row g-1">
                                    ...
                                    <input type="text" name="invoice_number" id="invoice_number"
                                        ...
                                        value="{{ $order->details->first()?->refund_store_number??'' }}" required>
