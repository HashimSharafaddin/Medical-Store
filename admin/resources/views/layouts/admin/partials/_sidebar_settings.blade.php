                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/pages/business-page*') ? 'active' : '' }}">
                                    ...
                                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                        ...
                                        <li class="nav-item {{ Request::is('admin/business-settings/pages/business-page/order') ? 'active' : '' }}">
                                            <a class="nav-link " href="{{ route('admin.business-settings.order') }}"
                                               title="{{ _('سياسة الطلب') }}">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span class="text-truncate">{{ _('سياسة الطلب') }}</span>
                                            </a>
                                        </li>
