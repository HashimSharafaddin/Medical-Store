...
<head>
    ...
    <link rel="apple-touch-icon" href="{{\App\CentralLogics\Helpers::get_full_url('business', $logo?->value?? '', $logo?->storage[0]?->value ?? 'public','favicon')}}">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="text-center">
                                ...
                                <button href="{{route('vendor.order.list',['all'])}}"   class="btn btn-primary check-order">{{translate('messages.Ok, let me check')}}</button>
                                </a>
                            </div>
                        </div>
                    </div>
...
"use strict";
    ...
    setInterval(function () {
            $.get({
                url: '{{route('vendor.order.get-order-data')}}',
                dataType: 'json',
